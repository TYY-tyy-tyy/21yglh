...
/* ------------------------------------------------ */
/* 陀螺仪积分角度 */
int Gyro_In_Left = 70;//70
int Gyro_Out_Left = 80;

int Gyro_In_Right = 80;
int Gyro_Out_Right = 80;

/* 环的数量 */
int Left_Ring_num = 5;
int Right_Ring_num = 5;

/* 出入环积分 */
int32 Left_Enc_In = 4000;
int32 Left_Enc_Out = 4000;
int32 Right_Enc_In = 4000;
int32 Right_Enc_Out = 4000;
...
/* 脉冲积分 */
int16 Encoder_jifen_L;
int16 Encoder_jifen_R;
...
/* -----------------------左圆环------------------------- */
/* 标志位 */
int Find_Left_FLAG = 0;

/* 左边局部丢线数量 */
int Left_local_LostNums = 0;

/* -----------------------右圆环------------------------- */
/* 标志位 */
int Find_Right_FLAG = 0;

/* 右边局部丢线数量 */
int Right_local_LostNums = 0;
...
void Find_Left_Ring(void)
{
    ...
    {
        if((Left_dowm_Patch >= 40) && (Right_dowm_Patch == 0) && (Left_local_LostNums >= 10) && (Left_Lost_Line_count <= 30) && (Right_Lost_Line_count <= 5) && (White_Column_MID >= 100) && (White_Nums > 45))
        {
            //若是，则进入圆环标志位1
...
void Find_Right_Ring(void)
{
    ...
    {
        if((Right_dowm_Patch >= 40) && (Left_dowm_Patch == 0) && (Right_local_LostNums >= 10) && (Right_Lost_Line_count <= 23) && (Left_Lost_Line_count <= 5) && (White_Column_MID >= 100) && (White_Nums > 45))
        {
            //若是，则进入圆环标志位1
