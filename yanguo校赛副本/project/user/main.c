...
uint32 use_time,i = 0;       //计时变量     3ms多处理一帧
...
////	Right_Motor_Speed(2000);
	pid.Speed_KP_L = pid.Speed_KP_R = 13;//正常值：6.8；一次超调值：13
...
//			tft180_show_string(0,Image_H+32,"p");
//			tft180_show_string(0,Image_H+48,"d");
//			tft180_show_float(Image_W,Image_H,pid.Turn_GKD,3,3);
//			tft180_show_float(Image_W,Image_H+16,pid.Turn_KP,3,3);
//			tft180_show_float(Image_W,Image_H+32,KP_x_Increase,3,3);
//			tft180_show_float(Image_W,Image_H+48,pid.Turn_KP1,3,3);
//			tft180_show_float(0,Image_H+16,angle_ringR,3,3);
			tft180_show_int16(MT9V03X_W / 2,48,Image_error);
//			tft180_show_string(0,Image_H,"White_MID");
//			tft180_show_int16(0,Image_H+32,Image_error);
//			tft180_show_int16(Image_W+16,Image_H,Right_Lost_Line_count);
//			tft180_show_int16(0,Image_H+48,Turn_Out);
//			tft180_show_int16(Image_W+16,Image_H+14,Left_dowm_Patch);
//			tft180_show_int16(Image_W+16,Image_H+32,Right_dowm_Patch);
//			tft180_show_int16(Image_W+16,Image_H+48,Left_local_LostNums);
//			tft180_show_int16(Image_W+16,16,White_Nums);
//			tft180_show_int16(Image_W+16,32,Left_Lost_Line_count);
//			tft180_show_int16(Image_W+16,48,Right_Lost_Line_count);
		}
//==================== 菜单按键 ====================
