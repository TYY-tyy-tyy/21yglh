...
#else   
#define WIFI_SPI_TARGET_IP          "192.168.137.1"              // 连接目标的 IP,不要有空格！！！
#define WIFI_SPI_TARGET_PORT        "8088"                      // 连接目标的端口
#define WIFI_SPI_LOCAL_PORT         "8088"                      // 本机的端口 0：随机  可设置范围2048-65535  默认 6666
#endif
