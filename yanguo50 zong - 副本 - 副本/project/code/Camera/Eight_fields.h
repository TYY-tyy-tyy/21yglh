...
//宏定义
#define image_h         MT9V03X_H / 2       //图像高度
#define image_w         MT9V03X_W / 2       //图像宽度
...
extern uint8 far original_image[image_h][image_w];
extern uint8 far bin_image[image_h][image_w];//图像数组
